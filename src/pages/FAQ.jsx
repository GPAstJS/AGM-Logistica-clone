...
export default function FAQ() {
  ...
  return (
    <div className="font-montserrat">
      ...
      <div className="w-full bg-[#075e6c] text-4xl h-[8rem] font-montserrat    flex items-center justify-center uppercase text-white font-bold">
        <h1>PERGUNTAS E RESPOSTAS</h1>
      </div>

      <div className="w-90 flex flex-col items-center justify-center" >

        <div className="shadow-xl mt-20 w-90" >
      <Accordion className=" w-[60rem]" open={open === 1}>
        <AccordionHeader className="uppercase font-montserrat text-sm text-[#075e6c] " onClick={() => handleOpen(1)}>Qual é o controle de custos e capacidade atrelado a um plano para melhoria contínua de produtividade?</AccordionHeader>
        <AccordionBody className="w-[50rem] ">
        ...
        <div className="shadow-xl mt-5 w-90"  >
      <Accordion  className=" w-[60rem]" open={open === 2}>
      ...
      <Accordion  className=" w-[60rem]" open={open === 3}>
        ...
        <div className="shadow-xl mt-5" >
      <Accordion  className=" w-[60rem]" open={open === 4}>
        ...
        <div className="shadow-xl mt-5" >
      <Accordion  className=" w-[60rem]" open={open === 5}>
...
Podemos propor sinergia com demais clientes porque atuam e segmentos diferentes.
        ...
        <div className="shadow-xl mt-5" >
      <Accordion  className=" w-[60rem]" open={open === 6}>
        ...
        <div className="shadow-xl mt-5" >
      <Accordion  className=" w-[60rem]" open={open === 7}>
        ...
        <div className="shadow-xl mt-5" >
      <Accordion  className=" w-[60rem]" open={open === 8}>
        <AccordionHeader className="uppercase font-montserrat text-sm  text-[#075e6c] " onClick={() => handleOpen(9)}>Qual o sistema de controle de produtividade, eficiência, gerenciamento de inventário, etc.?</AccordionHeader>
        <AccordionBody className="w-[50rem]">
        ...
        <div className="shadow-xl mt-5" >
      <Accordion  className=" w-[60rem]" open={open === 10}>
        <AccordionHeader className="uppercase font-montserrat text-sm text-[#075e6c]  " onClick={() => handleOpen(10)}>Como é manejado as alterações de volume, pico de operação inesperado, necessidade de equipamentos inesperados, etc?</AccordionHeader>
        <AccordionBody className="w-[50rem]">
        ...
        <div className="shadow-xl mt-5" >
      <Accordion  className=" w-[60rem]" open={open === 11}>
        <AccordionHeader className="uppercase font-montserrat text-sm  text-[#075e6c] " onClick={() => handleOpen(11)}>
...
O modelo de gestão da AGM é matricial proporcionando ações e reações rápidas a demandas operacionais e de RH</AccordionHeader>
        ...
        <div className="shadow-xl mt-5" >
      <Accordion  className=" w-[60rem]" open={open === 12}>
        <AccordionHeader className="uppercase font-montserrat text-sm text-[#075e6c] " onClick={() => handleOpen(12)}>Como decisões são tomadas dentro da AGM? Quanto tempo leva e quem normalmente aprova as decisões de negócio?</AccordionHeader>
        <AccordionBody className="w-[50rem]">
        Estimamos um quadro a maior em 5% para cobertura de Absenteísmo, além de equipe de férias. Provisionamos multas de FGTS (50%) para ajustes no quadro visando atender a desligamentos não previstos antes do término de contrato.
        </AccordionBody>
      </Accordion>
