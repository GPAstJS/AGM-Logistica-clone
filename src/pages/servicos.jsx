...
export default function Servicos() {
  return (
    <div className="3xl:w-full flex flex-col items-center justify-center sm:w-[100%] font-montserrat">
      <Header />
        ...
        <div className="flex flex-col uppercase sm:w-[40rem] 3xl:w-[90rem]  items-center justify-center">
          <div className="flex sm:flex-col 3xl:flex-row h-[20rem] sm:mt-20 sm:w-[40rem] 3xl:w-full items-center justify-between">
            ...
            <div className="flex flex-col w-[37.5rem]">
              <p className="normal-case sm:w-full 3xl:w-[90%]">
          ...
          <div className="flex sm:flex-col 3xl:flex-row h-[20rem] sm:mt-20 sm:w-[40rem] 3xl:w-full items-center justify-between">
            ...
            <div className="flex flex-col w-[37.5rem]">
              <p className="normal-case 3xl:w-[90%] sm:w-full">
                Infraestrutura completa para estocagem/armazenagem de diversos
                tipos de produtos. 360.000m3 em conformidade com todas as
                regulações e segurança necessárias.
              </p>
          ...
          <div className="flex sm:flex-col 3xl:flex-row h-[20rem] sm:mt-20 sm:w-[40rem] 3xl:w-full items-center justify-between">
            ...
            <div className="flex flex-col w-[37.5rem]">
              <p className="normal-case sm:w-full 3xl:w-[90%]">
                Deixar a operação do seu parque logístico nas mãos de um
                especialista se traduz em ganho trabalhista e despreocupação.
                Conheça mais sobre o Outsourcing em Logística.
              </p>
          ...
          <div className="flex sm:flex-col 3xl:flex-row h-[20rem] sm:mt-20 sm:w-[40rem] 3xl:w-full items-center justify-between">
            ...
            <div className="flex flex-col w-[37.5rem]">
              <p className="normal-case sm:w-full 3xl:w-[90%]">
                Ingressar na economia circular pós 2020 é essencial. E a
                logística reversa é a principal ferramenta para a redução de
                custoso e aumento de valor da sua marca ou produto.
              </p>
          ...
          <div className="flex sm:flex-col 3xl:flex-row sm:mb-20 sm:mt-20 h-[20rem] sm:w-[40rem] 3xl:w-full items-center justify-between">
            ...
            <div className="flex flex-col w-[37.5rem]">
              <p className="normal-case sm:w-full 3xl:w-[80%]">
                Soluções em transporte em todas as etapas do processo, da
                indústria para o centro de distribuição e para o consumidor
                final. Conheça nossos modais de transporte.
              </p>
